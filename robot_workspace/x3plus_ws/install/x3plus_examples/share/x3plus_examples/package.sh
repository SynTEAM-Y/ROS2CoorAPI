...
_colcon_package_sh_COLCON_CURRENT_PREFIX="/home/othman/ROS2CoorAPI/robot_workspace/x3plus_ws/install/x3plus_examples"
...
# source sh hooks
_colcon_package_sh_source_script "$COLCON_CURRENT_PREFIX/share/x3plus_examples/hook/path.sh"

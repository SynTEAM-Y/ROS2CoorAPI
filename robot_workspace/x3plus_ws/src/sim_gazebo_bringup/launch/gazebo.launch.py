...
def generate_launch_description():
    ...
    # Joint State Publisher node (CRITICAL: needed for wheels to move!)
    # This reads joint states from Gazebo and publishes them to /joint_states
    ...
    launch_desc = [
        ...
        joint_state_publisher_node,  # CRITICAL: Must run for joint commands
        gazebo_launch,
        spawn_robot_node,
    ]
